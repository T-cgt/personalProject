...
<div>
  <div>
    <el-input size="small" v-model="jl.name" placeholder="添加职称"
    prefix-icon="el-icon-plus" style="width: 300px"></el-input>
    <el-select v-model="jl.titleLevel" placeholder="职称等级" size="small" style="margin:auto 8px">
      <el-option
  ...
  <el-dialog
      ...
      <tr>
        ...
        <td><el-input v-model="updateJl.name" size="small" style="margin-left: 8px"></el-input></td>
      </tr>
        <tr>
          <td>
            <el-tag>职称等级</el-tag>
          </td>
          <td><el-select v-model="updateJl.titleLevel" placeholder="职称等级" size="small" style="margin:auto 8px">
            <el-option
                v-for="item in titleLevels"
                :key="item"
                :label="item"
...
export default {
  ...
  methods:{
    ...
    initJls(){
      this.getRequest('/system/basic/joblevel/').then(resq=>{
        if(resq){
          this.jls=resq;
          this.jl.name='';
          this.jl.titleLevel=''
